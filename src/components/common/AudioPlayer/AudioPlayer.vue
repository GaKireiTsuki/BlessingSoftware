            ...
            <div class="playback_controls" :class="songID.length != '' ? 'enabled':'disable'">
                ...
                <div class="controls_button">
                    ...
                    <button class="play_pause_song" :class="songID.length != '' ? 'enabled':'disable'">
                        <svg v-show="playIng != true" @click="ControlPlay" width="100%" height="100%" viewBox="0 0 34 34" version="1.1" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve"
                            style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:1.41421">
                            <path
                        ...
                        <svg v-show="playIng != false" @click="ControlPause" width="100%" height="100%" viewBox="0 0 34 34" version="1.1" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve"
                            style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:1.41421">
                            <path
